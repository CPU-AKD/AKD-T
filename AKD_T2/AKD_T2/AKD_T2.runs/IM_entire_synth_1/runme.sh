...
HD_PWD='C:/Users/hp/Desktop/FPGA/CPU/AKD_T/AKD_T2/AKD_T2/AKD_T2.runs/IM_entire_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log IM_entire.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source IM_entire.tcl
